...
LDFLAGS = -fopenmp 
LIBOBJS = 
LIBS =  /xchip/gistic/Jeremiah/GIT/apophenia-clone//lib/libapophenia.a -L/xchip/gistic/Jeremiah/software/gsl-2.2.1/lib -lsqlite3 -lgsl -lgslcblas -lpthread -lrt -lz 
LTLIBOBJS = 
MAINT = #
MAKEINFO = makeinfo
MKDIR_P = /bin/mkdir -p
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gsl_lib = -L/xchip/gistic/Jeremiah/software/gsl-2.2.1/lib
host_alias = 
htmldir = ${docdir}
